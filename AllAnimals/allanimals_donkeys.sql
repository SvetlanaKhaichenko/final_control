...
CREATE TABLE `donkeys` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  CONSTRAINT `donkeys_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `typesanimals` (`id_type`) ON DELETE CASCADE
...
INSERT INTO `donkeys` VALUES (1,'Zakky',6,'2019-03-24','Walk, Bray, Kick'),(2,'Burritos',6,'2022-01-17','Walk, Run');
