...
CREATE TABLE `hamsters` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  CONSTRAINT `hamsters_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `typesanimals` (`id_type`) ON DELETE CASCADE
...
INSERT INTO `hamsters` VALUES (1,'Hammy',3,'2024-08-12','Spin, Roll'),(2,'Slippy',3,'2022-04-16','Roll, Hide');
